                    ...
                    <CompactModal onClick={e => e.stopPropagation()} style={{ maxWidth: '360px', maxHeight: '80vh', overflowY: 'auto' }}>
                        <div style={{ padding: '4px 0' }}>
                            <h3 style={{ margin: '0 0 12px 0', fontSize: '1rem', fontWeight: 600, color: '#333', display: 'flex', alignItems: 'center', gap: '8px' }}>
                                <FiHelpCircle size={18} /> {t.drawing?.help || 'Help'}
                            </h3>

                            <div style={{ marginBottom: '16px' }}>
                                <h4 style={{ margin: '0 0 8px 0', fontSize: '0.8rem', fontWeight: 600, color: '#495057' }}>⌨️ {t.drawing?.help_shortcuts || 'Shortcuts'}</h4>
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6px 16px', fontSize: '0.75rem' }}>
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}><span style={{ color: '#495057' }}>{t.drawing?.sc_arrow || 'Arrow'}</span><kbd style={{ background: '#f8f9fa', padding: '2px 8px', borderRadius: '4px', fontFamily: 'monospace', fontSize: '0.7rem', border: '1px solid #dee2e6', boxShadow: '0 1px 0 #dee2e6', color: '#333' }}>A</kbd></div>
