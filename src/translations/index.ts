export const translations = {
    en: {
        ...
        settings: {
            ...
            import_note: "Data is safely merged with existing entries. Relationships between logs and comments are automatically relinked by the system.",
            language: "Language",
            english: "English",
            korean: "Korean",
    ...
    ko: {
        ...
        settings: {
            ...
            import_note: "기존 데이터와 안전하게 병합됩니다. 로그와 댓글 사이의 연결 관계는 시스템이 자동으로 다시 맞춰주므로 안심하고 사용하셔도 됩니다.",
            language: "언어",
            english: "English",
            korean: "한국어",
